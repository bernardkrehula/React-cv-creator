            ...
            <div className="main-preview">
                ...
                <div className="main-info">
                    ...
                    <div className="info-space">
                        ...
                        <li name='education' className="education-info">
                            <h3>Education</h3>
                            <hr />
                        </li>
                        <li name='experience' className="experience-info">
                            <h3>Experience</h3>
                            <hr />
                        </li> */}
                        </ul>
